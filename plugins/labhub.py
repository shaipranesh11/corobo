...
class LabHub(BotPlugin):
    ...
    def assign_cmd(self, msg, match):
        ...
        eligility_conditions = [
            ...
            '- You cannot be assigned to a medium level issue unless '
            'if you are not a developer. '
            'If you want to be a developer you need to '
            'complete all the 5 tasks in '
            'http://api.coala.io/en/latest/'
            'Developers/Newcomers_Guide.html'
        ]
